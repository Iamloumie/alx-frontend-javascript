 ...
 * @param {StudentConstructor} studentConstructor - The constructor for the student.
 */
...
class StudentClass implements StudentClassInterface {
  ...
  constructor(studentConstructor: StudentConstructor) {
    this.firstName = studentConstructor.firstName;
    this.lastName = studentConstructor.lastName;
  }
